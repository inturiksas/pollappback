...
public class UserDAO implements IUserDAO {
	 ...
	 * @param password
	 * 
	 * @return <User> an User entities
	 */
	public User findByEmailByPassword(String email, String password) {
		EntityManagerHelper.log("finding User by email and password",
				Level.INFO, null);
		try {
			final String queryString = "select model from User model where model.email= :emailValue And model.password= :passwordValue";
			Query query = getEntityManager().createQuery(queryString);
			...
			EntityManagerHelper.log("findByEmailByPassword failed",
					Level.SEVERE, re);
			throw re;
		}
	}
